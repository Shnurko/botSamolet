...
@Component
class MenuCommand(private val productRepository: HouseRepository) : BotCommand(CommandName.MENU.text, "") {
    override fun execute(absSender: AbsSender, user: User, chat: Chat, arguments: Array<out String>) {
        ...
        inlineButtons += listOf(listOf("$callback|myfav" to "⭐Избранное"))
